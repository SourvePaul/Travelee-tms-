...
<html>
<head>
<title>Travelee | Admin manage Bookings</title>
...
left join sslcommerz_payment_info on sslcommerz_payment_info.book_id = tblbooking.BookingId;";
$query = $dbh -> prepare($sql);
$query->execute();
...
if($result->status==0 and  $result->cancelby=='a')
{
echo "Canceled by you at " .$result->upddate;
} 
if($result->status==0 and $result->cancelby=='u')
{
